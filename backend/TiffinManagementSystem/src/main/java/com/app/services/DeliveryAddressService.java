...
public class DeliveryAddressService {
	...
	public Map<String,Integer> deleteById(int id) {
		
		DeliveryAddress d=deliveryAddressDao.findByLocationId(id);
		if(d!=null) {
			deliveryAddressDao.deleteById(id);
			return Collections.singletonMap("DeletedId", d.getLocationId());
		}else {
			return Collections.singletonMap("DeletedId",0);
		}
	}
}
